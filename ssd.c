...
// char* result_file_statistic = "results\\opt\\homes_statistic_opt_640_70v.txt";
// char* result_file_statistic = "results\\opt\\mail5_statistic_opt_640_70v.txt";
// char* result_file_statistic = "results\\opt\\trace_10_dup_statistic_opt_640_70v.txt";
char* result_file_statistic = "results\\opt\\trace_50_dup_statistic_opt_640_70v.txt";

char* result_file_ex =  "trace_30_dup_output_opt_160_30v.txt";

// char* stat_file = "results\\opt\\dedup_opt_homes_640_70v.csv";
// char* stat_file = "results\\opt\\dedup_opt_mail5_640_70v.csv";
// char* stat_file = "results\\opt\\dedup_opt_trace_10_dup_640_70v.csv";
char* stat_file = "results\\opt\\dedup_opt_trace_50_dup_640_70v.csv";
...
void make_aged(struct ssd_info *ssd)
{
	...
	dup_ppn_nb = (unsigned int)(NVRAM_MB * 1024 * 1024 / 16 * 0.9 * NVRAM_VALID); //  NVRAM, 90% used, valid entry
